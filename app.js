document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleHashChange() {
        ...
        const validTabs = ['home', 'resume', 'projects'];
        ...
        if (validTabs.includes(tabId)) {
            switchTab(tabId);
            if (tabId !== 'projects' && typeof resetTimelineView === 'function') {
                resetTimelineView();
            }
    ...
    function showProjectDetail(projectId) {
        ...
        if (detailViewContainer) {
            ...
            // Treat project detail as a dedicated screen inside the projects tab
    ...
    // Initial load routing after all project elements are initialized
    handleHashChange();
